function [A,B,C] = ThoracoHumeralAngles(Q, model)
...
% 	R_Thorax2Arm = R_Global2Thorax*invR(R_Global2Arm);
	...
	R_Global2Arm = GL(1:3,1:3,5);
	R_Thorax2Arm = R_Global2Thorax'*R_Global2Arm;

	
	[a, b, c] = angleRotation(R_Thorax2Arm(1:3,1:3), 'zyzz');

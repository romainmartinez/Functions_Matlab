...
% Interval=3; % Des que les data sont sup ou inf � ValFmin + ou - 3 Newtons
% 
...
% DebutForce=min(SValDForce)-20; % -20 frames, arbitrairement design�, c'est
...
% FinForce= length(FTA)-FinForceF+30; % 30frame ici car Intervalle � 5 Newton
